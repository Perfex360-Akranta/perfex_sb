...
@Entity
@Table(name = "plm_tl_conditionalappraisal", schema = "public")
public class PlmTlConditionalappraisal {
    ...
    @Column(name = "cdap_tempfield1", length = 1, nullable = false)
    ...
    public void setCdam_keyid(String cdamKeyid) {
        this.cdam_keyid = cdamKeyid;
    }
    ...
    public void setComponent_type(Character componentType) {
    ...
    public void setRefurbishment_status(Character refurbishmentStatus) {
        this.refurbishment_status = refurbishmentStatus;
    }
